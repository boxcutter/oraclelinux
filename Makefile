...
PARALLELS_TEMPLATE_FILENAMES := $(filter-out oel510-i386.json oel510.json oel511-i386.json oel511.json oel57-i386.json oel57.json oel58-i386.json oel58.json oel59-i386.json oel59.json,$(TEMPLATE_FILENAMES))
